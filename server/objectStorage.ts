...
export class ObjectStorageService {
  ...
  // Gets the upload URL for a network icon.
  async getNetworkIconUploadURL(iconName: string): Promise<string> {
    ...
    // Use the first public path for network icons
    const iconPath = `${publicObjectSearchPaths[0]}/network-icons/${iconName}`;
