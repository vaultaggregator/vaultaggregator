...
export const BaseIcon = ({ className = "", size = 24 }: ChainIconProps) => (
  ...
  >
    ...
    <path
      d="M16.005 6.995c4.974 0 9.005 4.03 9.005 9.005S20.979 25.005 16.005 25.005c-3.317 0-6.208-1.796-7.796-4.467H13.5c.828 0 1.5-.671 1.5-1.5v-6c0-.828-.672-1.5-1.5-1.5H8.209c1.588-2.671 4.48-4.467 7.796-4.467z"
      fill="white"
    />
  </svg>
);
