    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2" data-testid="text-contact-subtitle">Get in touch with our team - we're here to help with any questions or feedback<br />vaultaggregator@protonmail.com</p>
        </div>
