  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900" data-testid="text-privacy-title">
            Privacy Policy
          </h1>
          <p className="text-gray-600 mt-2" data-testid="text-privacy-subtitle">
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Blockchain Data</h4>
                <ul className="text-sm text-gray-600 space-y-1 ml-4 list-disc">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-gray-600 mt-4">
                ...
                <a href="mailto:privacy@vault-aggregator.com" className="text-blue-600 hover:underline">
